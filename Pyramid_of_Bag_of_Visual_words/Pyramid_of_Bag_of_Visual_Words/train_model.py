# USAGE
# python train_model.py --dataset output/data/training --features-db output/training_features.hdf5 --pbow-db output/training_pbow.hdf5 --model output/model.cpickle
