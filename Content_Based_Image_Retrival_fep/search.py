...
'''
usage:
    python search.py --dataset ../ukbench_samples --features-db output/features.hdf5 --bovw-db output/bovw.hdf5 --codebook output/vocab.cpickle --relevant ../ukbench_samples/relevant.json --query ../ukbench_samples/ukbench00258.jpg
