...
python evaluate_spatial_verify.py --dataset ../ukbench_samples --features-db output/features.hdf5 --bovw-db output/bovw.hdf5 --codebook output/vocab.cpickle --idf output/idf.cpickle --relevant ../ukbench_samples/relevant.json
